...
//           .toString()
//           .toLowerCase()
//           .includes(searchValuse.toString().toLowerCase())
//       );
//     });
...
//       <div
//         className={`${
//           isOpen ? "searchBerSuggestDev" : "searchBerSuggestRemove"
//         }`}
//       >
//         {searchValuse ? (
//           userSearch.slice(0, 10).map((item: any) => (
