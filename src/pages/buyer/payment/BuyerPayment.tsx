...
const BuyerPayment = () => {
    ...
    return (
        <div>
            ...
            <div style={{ padding: '20px', backgroundColor: '#002952b2', borderRadius: '5px 5px 0 0' }}>
                <h5 style={{ color: 'white', margin: "0", fontWeight: '700' }}>My Payments ({myOrderData?.data?.length})</h5>
            </div>
