...
const KidsAccessoriesCategore = () => {
  ...
  return (
    <div className="nestedProductsMain">
      <PageTitle pageTitle="Kids Accessories" />
      <div className="nestedProductsSortByViewPart">
        <div>
          <p className="m-0">
            {productQuantity} Products Found In Kids Accessories
          </p>
        </div>
...
export default KidsAccessoriesCategore;
