...
const GroceriesFoodsCategore = () => {
  ...
  return (
    <div className="nestedProductsMain">
      <PageTitle pageTitle="Groceries & Foods" />
      <div className="nestedProductsSortByViewPart">
        <div>
          <p className="m-0">{productQuantity} Products Found In Foods</p>
        </div>
...
export default GroceriesFoodsCategore;
